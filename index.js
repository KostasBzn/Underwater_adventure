...
function gameIntro() {
  console.log("Press ENTER to start the story........");
  const enter = prompt();
  if (enter === "") {
    clearConsole();
  } else {
...
async function playGame() {
  ...
  if (difficultyChoice === "1") {
    ...
    const dayQuestions = [
      {
        ...
        choices: ["He forgets to check the tanks capacity", "He forgets to do the stretches"],
        correctChoice: 1,
      ...
      },
      {
        ...
        choices: ["He ventures deeper anyways", "He decides to check his reservoir"],
        correctChoice: 0,
      ...
      { //
        ...
        choices: ["His inner curiosity makes him go towards it", "He stays for a bit longer"],
        correctChoice: 1,
      ...
      { //
        ...
        choices: ["He decides to follow the light", "Silently tries to calm down"],
        correctChoice: 1,
        nextQuestionIfCorrect: 2,
        nextQuestionIfIncorrect: 8,
      },
    ...
    for (let currentQuestionIndex = 0; currentQuestionIndex < dayQuestions.length;) {
      const {
        question,
        choices,
        correctChoice,
    ...
    for (let currentQuestionIndex = 0; currentQuestionIndex < nightQuestions.length;) {
      const {
        question,
        choices,
        correctChoice,
